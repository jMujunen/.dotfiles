...
alias reactivate="source /home/joona/.venv/bin/activate"
...
alias dl="cd $HOME/Downloads/ && eza -luh --sort=created"
alias docs="cd_docs"
...
alias feh="feh -g 1920x1080 --draw-filename --draw-tinted \
-S filename --scale-down --cache-size=1024 --output-dir=/home/joona/Pictures/feh \
--quiet --borderless -C /usr/share/fonts/TTF/ --title-font=FantasqueSansMNerdFontMono-Regular/11"
...
alias ipy="/home/joona/.venv/bin/ipython3 \
    --pprint --nosep --no-confirm-exit --profile=main --colors=Linux"
...
alias eza='eza --color=always --group-directories-first  \
    --git --smart-group --time-style="+%-d %b %-I:%M %p"'
alias ls='eza -A'
alias la="eza -lA"
alias ll="eza -lA"
alias l="eza -lSr"
alias lt="eza -Al --time=modified --sort=modified "
...
alias x="exit"
alias yay="deactivate 2>/dev/null; yay --color=always"
alias md='python -m rich.markdown --code-theme material --width=90'
...
alias plist='[[ -d $HOME/.dotfiles/ ]] && pacman -Qqe >  \
    $HOME/.dotfiles/.pacman-pkglist.txt \
...
alias ffp='nohup firefox -P private &>/dev/null & disown; exit'
