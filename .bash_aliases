...
--borderless --stretch --o--output=montage.png -C /usr/share/fonts/TTF/ --title-font=FantasqueSansMNerdFontMono-Regular/12'
...
alias osrs="nohup flatpak run com.jagexlauncher.JagexLauncher &>/dev/null && exit"
...
alias kittycam-term='nohup kitty +kitten panel --config="/home/joona/.config/kitty/panel.d/bg_padded.conf" --edge=background  mpv http://10.0.0.50:8081 --profile=big-cache --profile=network --profile=term &>/dev/null && exit'
alias kppower="nohup kitty +kitten panel --edge=background sh -c 'gpu_power.sh' &>/dev/null && exit"
