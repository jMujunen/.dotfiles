# Generated by Powerlevel10k configuration wizard on 2024-05-08 at 13:49 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_ICON_PADDING=Medium
  ...
  typeset -g POWERLEVEL9K_BACKGROUND='#2A3339'
  #236
  ...
  # You can define different colors, icons and content expansions for different classes:
  #
  #   typeset -g POWERLEVEL9K_AZURE_TEST_FOREGROUND=28u
